...
def test_doc() -> None:
    ...
    doctest.run_docstring_examples(summary, globals(), verbose=True)  
    doctest.run_docstring_examples(ith, globals(), verbose=True)  
    doctest.run_docstring_examples(isStress, globals(), verbose=True)  
